...
$hero_overlay = get_theme_mod( 'knife_edge_img' );
...
<style>
	...
	.hero-overlay-front {
		background-image: url( <?php echo $hero_overlay; ?> );
	}
	
	.hero-img-back, .hero-overlay-front {
		width: 70%;
	}
	...
	.hero-sm-img-back {
		background-image:url(<?php echo $hero_overlay?>);
		background-color: <?php echo $hero_bg_color_sm; ?>;
	}
...
<section class="container-fluid outer hero d-none d-sm-block">
	<div class="wrapper inner hero-wrap">
		<div class="row w-100">
			<div class="col-sm-12 col-md-6 col-lg-6 hero-text-color">
				<h2><?php echo $page_title; ?></h2>
			<?php if( !empty( $cta_subtitle ) ) : ?>
				<h4><?php echo $cta_subtitle; ?></h4>
			<?php endif; ?>
			</div>
		</div>
	</div>
	<div class="hero-overlay-front"></div>
	<div class="hero-img-back"></div>
</section>

<section class="container-fluid outer hero-sm d-block d-sm-none w-100">
	<div class="wrapper inner">
		<div class="row m-0">
			<div class="col-sm-12 col-md-12 col-lg-12 w-100 hero-sm-overlay-front"></div>
			<div class="col-sm-12 col-md-12 col-lg-12 w-100 hero-sm-img-back">
				<div class="row d-flex d-md-none align-items-center h-100">
					<div class="col-sm col-md col-lg text-left hero-text-color">
						<h2><?php echo $page_title; ?></h2>
					<?php if( !empty( $cta_subtitle ) ) : ?>
						<h4><?php echo $cta_subtitle; ?></h4>
					<?php endif; ?>
